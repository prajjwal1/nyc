...
NYC_NEIGHBORHOODS = {
    ...
    "cobble hill": ["cobble hill", "atlantic ave"],
    "boerum hill": ["boerum hill"],
    "crown heights": ["crown heights", "franklin ave"],
    "bed-stuy": ["bed-stuy", "bedford-stuyvesant", "tompkins ave", "nostrand ave"],
    "long island city": ["long island city", "lic", "vernon blvd", "jackson ave", "43rd ave"],
    "astoria": ["astoria", "ditmars", "30th ave"],
    "soho": ["soho", "spring st", "prince st", "greene st", "mercer st", "wooster st"],
    "tribeca": ["tribeca", "franklin st", "leonard st", "white st"],
    "chelsea": ["chelsea", "w 20th", "w 21st", "w 22nd", "w 23rd", "w 24th", "w 25th"],
    "west village": ["west village", "bleecker st", "w 4th", "perry st", "christopher st"],
