...
IG_ACCOUNTS = list(
    dict.fromkeys(
        [  # dedupe while preserving order
            ...
            "oldmanrunclub",
            "newyorkroad.runners",
            # More NYC run clubs (user ask: more run clubs, incl. recurring
            # weekly runs). Well-known, long-running NYC clubs that post
            # their weekly run schedule — the recurring-weekday detector
            # turns "every Tuesday 7pm" posts into dated occurrences.
            "harlemrun",
            "frontrunnersnewyork",
            "we_run_uptown",
            "orchardstreetrunners",
            "prospectparktrackclub",
            "endorphinsrun",
            "runclubnyc",
            "thebridgerunners",
            # Fitness / wellness studios & collectives
            "thenovemberproject",
            "chelseapiersfitness",
...
USER_INTERESTS = {
    ...
    "boost_categories": {
        ...
        "dance": 1.1,
        "wellness": 1.2,  # Yoga/sound baths/wellness meetups (user ask:
        # more fitness-based events). Bumped 1.05→1.2.
...
SOURCE_QUALITY = {
    ...
    "brooklyncontra": 0.8,  # curated recurring live-music contra dance
